...
<div id="payremind_div" class="d_none">
    <div class="card">
        <div class="card-header"><span class="fa fa-bookmark"></span><span class="margin_l5">登录平台支付</span></div>
        <div class="card-body">
...
<ul class="d-flex justify-content-around">
	...
	<li><a  href="#"><i class="fa fa-shopping-bag" aria-hidden="true"></i><span>商城</span></a></li>
