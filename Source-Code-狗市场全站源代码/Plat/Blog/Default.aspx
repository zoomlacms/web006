...
<div id="pcmsgdiv">
  ...
  <div class="msgop msg_opdiv"><a href="javascript:;" onclick="ShowDiv('topicDiv');"><span class="spanico">#</span><span>话题</span></a>
	...
	<a href="javascript:;" onclick="ShowGroupAt();"><span class="spanico">@</span><span>AT</span>
	  ...
	  <span class="fa fa-eye margin_l5 spanico"></span> <span id="canSee_Span">公开</span></a><!--根据其中所选-->
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
	<div class="modal-content">
	  <div class="modal-body padding0">
		<div class="site_mail_title d-flex"><span>站内邮</span><span class="fa fa-remove grayremind ml-auto EClose_btn" title="关闭" onclick="PrivateClose();"></span> </div>
		<table id="privatetable">
		  ...
		  <tr>
			...
			<td><div class="input-group width100">
				...
				<span class="input-group-append cursour" onclick="PrivateSelUser('private');"><span class="input-group-text"><i class="fa fa-plus"></i></span></span></div></td>
		  </tr>
		  <tr>
...
<div style="position:absolute;right:10px;top:80px;" class="plat_right hidden-sm hidden-xs">
    ...
    <div class="comp_body work-clock">
		...
		<i class="fa fa-clock-o" style="color:#51C23A;"></i> <span>考勤</span>
		<a href="/Plat/Blog/Attendance.aspx" class="more ml-auto mr-2" title="查看记录"><i class="fa fa-chevron-right"></i></a>
		</div>
		</div>
        <div class="comp_content">
            ...
            <div class="attend-btn text-center p-1">
				<button id="signin_btn" onclick="sign.signin()" type="button" class="btn btn-info hidden w-100 "><i class="fa fa-sign-in"></i> 签到</button>
                <button id="signout_btn" onclick="sign.signout()" type="button" class="btn btn-info w-100"><i class="fa fa-sign-out"></i> 签退</button>
            </div>
        </div>
    </div>
    <div class="comp_body">
        <div class="comp_tit">
		<div class="d-flex mt-2">
		<i class="fa fa-desktop" style="color:#FF8C1A"></i>
		<span>公告</span>
		<a href="/Index" target="_blank" class="more ml-auto mr-2" title="查看更多"><i class="fa fa-chevron-right"></i></a>
		</div>
		</div>
        <div class="comp_content">
