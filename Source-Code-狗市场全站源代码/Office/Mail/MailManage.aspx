...
<li class="list-group-item  list-group-item-action" id="MessageSend"><a href="javascript:;" data-target="/Office/Mail/MessageSend.aspx"><i class="fa fa-pencil-square"></i> 写信</a></li>
<li class="list-group-item list-group-item-action" id="Message1"><a href="javascript:;" data-target="/Office/Mail/Message.aspx"><i class="fa fa-envelope-square"></i> 收信</a></li>
<li class="list-group-item list-group-item-action" id="Contact"><a href="javascript:;" data-target="/Office/Other/StructList.aspx?action=struct&value=2"><i class="fa fa-users"></i> 通讯录</a></li>
</ul>
</div>
