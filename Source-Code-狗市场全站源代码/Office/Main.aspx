                    ...
                    <div class="OAborder">
                        <div class="duty_t" style="background: url('Images/Document.gif') no-repeat;">
                            <div class="duty_tp d-flex">
								...
								<i class="fa fa-close" aria-hidden="true" onclick="closeDiv(this);"></i>
                                <i class="fa fa-compress oaarrow" aria-hidden="true"  onclick="coll(this);"></i>
                                <i class="fa fa-expand oaarrow" aria-hidden="true"  onclick="coll2(this);" style="display: none;"></i>
								</div>
                            </div>
                        </div>
                                ...
                                <table class="myTable threeTr table">
                                    <tr class="hover_hander">
                                        <td scope="col"><a href="Flow/FlowApply.aspx?ProID=1">
                                            <i class="fa fa-sign-in prcess"></i><div>新建收文</div>
                                        </a></td>
                                        <td scope="col"><a href="Flow/FlowApply.aspx?ProID=2">
                                            <i class="fa fa-sign-out prcess"></i><div>新建发文</div>
                                        </a></td>
                                        <td scope="col"><a href="Flow/FlowApply.aspx?ProID=3">
                                            <i class="fa fa-clock-o prcess"></i><div>新建请假</div>
                                        </a></td>
                                        <td scope="col"><a href="Flow/FlowApply.aspx?ProID=4">
                                            <i class="fa fa-group prcess"></i><div>新建会议</div>
                                        </a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td scope="col">
