...
<div class="left_user">
	...
	<div class="commonuser" runat="server" id="leftChk3">
		<div class="common_t">
			...
			<i class="fa fa-compress oaarrow oaarrow" onclick="hideC(this);" style="display: none;"></i>
			<i class="fa fa-expand oaarrow oaarrowDown" onclick="showC(this);"></i>
			</div>
			</div>
		</div>
	...
	<div class="commonuser" runat="server" id="leftChk5">
		<div class="history_t">
			...
			<span>便捷访问</span>
			<div class="ml-auto mr-3">
				<i class="fa fa-compress oaarrow oaarrow" onclick="hideC(this);"></i>
				<i class="fa fa-expand oaarrowDown" style="display: none;" onclick="showC(this);"></i>
			</div>
<!--
				<i class="fa fa-compress oaarrow oaarrow" onclick="hideC(this);" style="display: none;"></i>
				<i class="fa fa-expand oaarrow oaarrowDown" onclick="showC(this);"></i>
