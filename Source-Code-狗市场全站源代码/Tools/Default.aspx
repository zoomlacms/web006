...
<div id="SupperGavel" class="sys_loginBox" runat="server" visible="false">
        <h1><i class="fa z01-icon190"></i>系统维护工具</h1>
...
<div id="SupperGavelCon" runat="server">
        <div class="jumbotron">
            <div class="container tools_banner_main">
                ...
                <hr class="my-4">
                <a href="<%:CustomerPageAction.customPath2 %>Default.aspx" class="btn btn-sm btn-info"><i class="fa fa-chevron-left" aria-hidden="true"></i> 返回后台</a> 
                <a href="../help.html" class="btn btn-sm btn-info"><i class="fa fa-chevron-left" aria-hidden="true"></i> 快速帮助</a>
                <a href="<%:CustomerPageAction.customPath2 %>SignOut.aspx" class="btn btn-sm btn-info"><i class="fa z01-icon153"></i> 退出登录</a>
            </div>
        </div>
        <div class="jumbotron admintop" id="admintop" runat="server" visible="false" hidden>
            <div class="container"><a href="<%:CustomerPageAction.customPath2 %>Default.aspx" class="btn btn-sm btn-info"><i class="fa fa-chevron-left" aria-hidden="true"></i> 返回后台</a> <a href="<%:CustomerPageAction.customPath2 %>SignOut.aspx" class="btn btn-sm btn-info"><i class="fa z01-icon153"></i> 退出登录</a> </div>
        </div>
        <div class="container">
        ...
        <div class="container SupperGavelTool">
            <ins>扩展工具:</ins>
            <ul class="row">
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://code.z01.com" target="_blank"><i class="fa fa-bold"></i><span class="glyphicon-class">BootStarp框架</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://app.z01.com" target="_blank"><i class="fa fa-mobile"></i><span class="glyphicon-class">微首页</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://app.z01.com/Class_1/Default.aspx" target="_blank"><i class="fa fa-weixin"></i><span class="glyphicon-class">场景列表</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://www.z01.com/tool/" target="_blank"><i class="fa fa-cog"></i><span class="glyphicon-class">站长工具</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://www.ziti163.com/webfont" target="_blank"><i class="fa fa-font"></i><span class="glyphicon-class">WebFont</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://ad.z01.com/" target="_blank"><i class="fa fa-picture-o"></i><span class="glyphicon-class">广告源码</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://ad.z01.com/color.html" target="_blank"><i class="fa fa-align-justify"></i><span class="glyphicon-class">网页配色</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://code.z01.com/" target="_blank"><i class="fa fa-laptop"></i><span class="glyphicon-class">响应式工具</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://v.z01.com/mb/" target="_blank"><i class="fa fa-briefcase"></i><span class="glyphicon-class">免费模板</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://www.z01.com/pub/" target="_blank"><i class="fa fa-download"></i><span class="glyphicon-class">下载逐浪CMS</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://bbs.z01.com/index" target="_blank"><i class="fa fa-users"></i><span class="glyphicon-class">技术社区</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="http://www.z01.com/mtv/" target="_blank"><i class="fa fa-video-camera"></i><span class="glyphicon-class">视频教程</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="https://www.z01.com/blog/techs/2975.shtml" target="_blank"><i class="fa fa-child"></i><span class="glyphicon-class">Emmet</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="https://www.ziti163.com" target="_blank"><i class="fa ZoomlaICO2015"></i><span class="glyphicon-class">字体网</span> </a></li>
                <li class="col-4 col-sm-3 col-md-2"><a class="d-flex flex-column" href="https://v.ziti163.com" target="_blank"><i class="fa fa-paint-brush"></i><span class="glyphicon-class">在线做字</span> </a></li>
            </ul>
        </div>
    </div>
...
<nav class="navbar navbar-expand-sm navbar-dark pl-0"> <a class="navbar-brand API_title" href="../../help.html">服务导航</a>
  ...
  <i class="fa z01-icon106 text-muted"></i></button>
  <div class="collapse navbar-collapse top_nav" id="top_nav">
    <ul class="navbar-nav mr-auto text-center Tools_nav_l">
      <li class="nav-item"><i class="fa fa-close nav_close_btn" aria-hidden="true"></i>
      ...
      <div class="form-inline" role="search">
              <div class="form-group d-flex flex-row Tools_searchbox mt-1">
                  ...
                  <button class="btn my-2 my-sm-0" type="button" onclick="openSearch();" style="background: none; margin-left: -3rem; color: #ff9d00;"><i class="fa fa-search"></i></button>
              </div>
