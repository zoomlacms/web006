        ...
        <div id="qtype_wrap" style="width:600px;margin:0 auto;">
                <ul id="qtype_ul" class="sys_ul quest_list">
                    <li onclick="tonew('radio','')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-check-circle-o"></i></div>
                            <span>单选</span>
                        </div>
                    </li>
                    <li onclick="tonew('checkbox','')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-check-square-o"></i></div>
                            <span>多选</span>
                        </div>
                    </li>
                    <li onclick="tonew('blank','')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-indent"></i></div>
                            <span>填空</span>
                        </div>
                    </li>
                    <li onclick="tonew('score','')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-star"></i></div>
                            <span>打分</span>
                        </div>
                    </li>
                    <li onclick="tonew('checkbox','')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-list-ul"></i></div>
                            <span>排序</span>
                        </div>
                    </li>
                    <li onclick="tonew('radio','sex')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-venus-mars"></i></div>
                            <span>性别</span>
                        </div>
                    </li>
                    <li onclick="tonew('blank','mobile')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-mobile"></i></div>
                            <span>手机</span>
                        </div>
                    </li>
                    <li onclick="tonew('blank','email')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-envelope"></i></div>
                            <span>邮箱</span>
                        </div>
                    </li>
                    <li onclick="tonew('blank','area')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-home"></i></div>
                            <span>地区</span>
                        </div>
                    </li>
                    <li onclick="tonew('blank','date')">
                        <div class="wrap">
                            <div class="q_icobox"><i class="fa fa-calendar"></i></div>
                            <span>日期</span>
                        </div>
                    </li>
                </ul>
