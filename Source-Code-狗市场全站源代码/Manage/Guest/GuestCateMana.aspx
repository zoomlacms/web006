...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Repeater runat="server" ID="RPT">
        ...
        <ItemTemplate>
            <tr data-layer="1" data-id="<%#Eval("CateID") %>" data-pid="0"  onclick="ShowChild(this,<%#Eval("CateID") %>);" ondblclick="ToggleChild(this);">
                ...
                <td><a href="TieList.aspx?CateID=<%#Eval("CateID") %>" title="浏览栏目内容"><span data-type="icon" class="<%#Convert.ToInt32(Eval("ChildCount"))>0?"fa fa-folder rep_tree_icon":"fa fa-file rep_tree_icon" %>" /></span></a>  <%#GetCateName()%></td>
    ...
    <script type="text/javascript">
        ...
        + "<a href='javascript:;' onclick='DelConfirm(@Cateid,0);'><i class='fa fa-trash-o' title='删除'></i>删除</a></td></tr>";
