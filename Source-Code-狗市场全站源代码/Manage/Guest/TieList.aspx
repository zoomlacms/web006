...
<asp:Label runat="server" ID="Bread_L"></asp:Label>
            ...
            <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" PageSize="20"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%#"/PItem?id="+Eval("ID") %>" target="_blank" ><%#lang.LF("<i class='fa fa-globe'></i>前台预览")%></a>
                            <asp:LinkButton ID="LinkButton3" runat="server" CommandName="QList" CommandArgument='<%# Eval("ID")+"&CateID="+Eval("CateID") %>'><i class="fa fa-navicon" title="内容"></i>贴子内容</asp:LinkButton>
                        </ItemTemplate>
    ...
    <div id="barinfo" style="display: none; ">
        <div class="text-center max20rem">
