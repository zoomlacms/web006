    ...
    <div id="BreadDiv" class="mysite">
        <div>
            <ol id="BreadNav" class="breadcrumb fixed-top">
				...
				<div id="help" class="pull-right text-center"><a href="javascript::" id="sel_btn"><i class="fa fa-search"></i></a><a onclick="help_show('102')" title="帮助" class="pl-2"><span class="fa fa-question-circle"></span></a></div>
            <div id="sel_box">
