...
<thead>
<th scope="col"></th>
<th scope="col"><asp:LinkButton runat="server" ID="ID_A" CommandArgument="AscID" OnClick="OrderBtn_Click">ID <i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
<th scope="col">用户名</th>
<th scope="col"><%=Resources.L.真实姓名 %></th>
<%--<th scope="col"><%=Resources.L.工号 %></th>--%>
<th scope="col"><%=Resources.L.会员组 %></th>
<th scope="col"><asp:LinkButton runat="server" ID="Purse_A" CommandArgument="Purse" OnClick="OrderBtn_Click"><%=Resources.L.资金 %><i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
<th scope="col"><asp:LinkButton runat="server" ID="Addtime_A" CommandArgument="Addtime" OnClick="OrderBtn_Click"><%=Resources.L.注册时间 %><i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
<th scope="col"><asp:LinkButton runat="server" ID="point_A" CommandArgument="point" OnClick="OrderBtn_Click"><%=Resources.L.积分 %><i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
<th scope="col"><asp:LinkButton runat="server" ID="LoginTimes_A" CommandArgument="LoginTimes" OnClick="OrderBtn_Click"><%=Resources.L.登录次数 %><i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
<th scope="col"><asp:LinkButton runat="server" ID="AuthTime_A" CommandArgument="AscAuthTime" OnClick="OrderBtn_Click"><%=Resources.L.最后登录时间 %><i class='fa fa-arrow-up order_img'></i></asp:LinkButton></th>
...
<div class="arrow"></div>
<h3 class="popover-header">会员概览<a href="javasvript:;" class="hidePopover" ><i class="fa fa-close" aria-hidden="true"></i></a></h3>
...
<a href="UserInfo.aspx?id=<%#Eval("UserID") %>&tabs=Tabs4" class="option_style"><i class="fa fa-product-hunt"></i>商品</a></td>
</tr>
</ItemTemplate>
