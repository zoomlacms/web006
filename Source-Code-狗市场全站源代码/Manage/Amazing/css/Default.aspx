...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="">
            <ItemTemplate>
			    <a href="CSSContent.aspx?id=<%#Eval("ID") %>"><i class="fa fa-pencil" title="创作"></i> 创作</a>
                ...
                <asp:LinkButton runat="server"  CommandName="down" CommandArgument='<%#Eval("ID") %>'><i class="fa fa-download"></i> 下载</asp:LinkButton>
