         ...
         <Columns>
            ...
            <ItemStyle CssClass="site_ico"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="site_a">
                 <ItemStyle HorizontalAlign="Left" />
                 <ItemTemplate>
                     <a href="javascript:;" title="浏览网站" onclick="testF(this,'getDomain', '<%#Eval("SiteName") %>','<%#Eval("SitePort") %>');"  title="浏览"><i class="fa fa-eye"></i></a>
                     ...
                     <a href="javascript:if(confirm('你确定要删除吗!')){ postToCS('del','<%#Eval("SiteName") %>')}"  title="删除"><i class="fa fa-trash"></i></a>
                     <%#ShowOPBtn() %>
                     <a href="javascript:postToCS('restart','<%#Eval("SiteName") %>')" title="重启" ><i class="fa fa-refresh"></i>重启</a>
                 </ItemTemplate>
                 <EditItemTemplate>
                     <asp:LinkButton ID="Save" runat="server" CommandName="Save" CommandArgument='<%# Container.DisplayIndex+":"+Eval("SiteID") %>'><i class="fa fa-refresh" title="更新"></i></asp:LinkButton>
                     <asp:LinkButton ID="Cancel" runat="server" CommandName="Cancel" CommandArgument='<%# Container.DisplayIndex %>' ><i class="fa fa-remove" title="取消"></i></asp:LinkButton>
                 </EditItemTemplate>
             </asp:TemplateField>       
         </Columns>
