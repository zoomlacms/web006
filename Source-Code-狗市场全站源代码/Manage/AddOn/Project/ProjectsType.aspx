    ...
    <ZL:ExGridView runat="server" ID="EGV" AllowPaging="true" AllowSorting="false"  class="table table-striped table-bordered" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton ID="LbtnUpdate" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="Update"><i class="fa fa-pencil" title="编辑"></i> 编辑</asp:LinkButton>
                    <asp:LinkButton ID="LbtnDel" runat="server" OnClientClick="return confirm('您确定要删除吗？')" CommandArgument='<%#Eval("ID") %>' CommandName="Del"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton> 
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
