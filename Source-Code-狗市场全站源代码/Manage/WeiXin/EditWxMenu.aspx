...
<div class="row sysRow list_choice table-responsive-md">
                    ...
                    <div class="action link_view" style="display: none;">
                        ...
                        <div class="w-100" style="margin: 10px, auto; display: inline-block;">
                            <div class="input-group">
                                <span class="input-group-prepend" id="basic-addon1"><span class="input-group-text"><i class="fa fa-link"></i></span></span>
    ...
    <div class="Conent_fix text-center">
        <button type="button" class="btn btn-info" onclick="SaveMenu()"><i class="fa fa-floppy-o"></i> 保存菜单</button>
        <button type="button" class="btn btn-outline-info" onclick="PreViewMenu()"><i class="fa fa-eye"></i> 手机预览</button>
    </div>
