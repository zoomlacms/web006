                ...
                <ul ng-app="app" ng-controller="ZLCtrl" class="sys_ul">
                    <li ng-repeat="item in list track by $index" class="input-group mb-2">
                        <input type="text" class="form-control max20rem" ng-model="item.text" />
                         <div class="input-group-append"><button type="button" class="btn btn-default" ng-if="$index==0" ng-click="add();"><i class="fa fa-plus"></i></button></div>
                         <div class="input-group-append"><button type="button" class="btn btn-default"ng-if="$index!=0" ng-click="del(item);"><i class="fa fa-minus"></i></button></div>
                    </li>
                </ul>
            </td></tr>
        </tbody>
