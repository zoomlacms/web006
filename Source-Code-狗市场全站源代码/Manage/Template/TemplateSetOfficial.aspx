...
<h1><i class="fa z01-icon185"></i> 模板云-轻松一键获取即可建立新的网站 <a title="免费云建站" target="_blank" href="//site.73ic.com" class="btn btn-outline-info">->免费在线拖拽式云建站</a>
</h1>
		...
		<ItemTemplate>
			<li class="Template_list_card">
				<div class="Template_box">
					...
					<li class="temp_title">
					<span class="pull-right pr-2"><a href="<%#GetDownUrl() %>" title="下载模板"><i class="fa fa-cloud-download"></i></a></span>
					<span class="pull-left"><a href="<%#GetDownUrl() %>" title="<%#Eval("Project") %>" style="padding-left:5px;"><%#Eval("Project") %></a></span>
					</li>
					
					<li class="temp_isuse"><i class="fa fa-user"></i> <%#Eval("Author") %></li>
					<li class="temp_del"><i class="fa fa-rmb"></i> 免费
					<a class="mr-2 lightbox" href='<%=serverdomain %>/Template/<%#Eval("TempDirName") %>/view.jpg' class="lightbox" title="大图预览"><i class="fa fa-search-plus"></i> 预览</a></li>
