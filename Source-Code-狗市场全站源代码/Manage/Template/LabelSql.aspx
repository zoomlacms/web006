	  ...
	  <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:LinkButton OnClick="UseLable_Click" class="btn btn-link" runat="server"><i class="fa fa-quote-left" aria-hidden="true"></i> 引用标签</asp:LinkButton>
      ...
      <tr>
            <td colspan="2">
                <div>
                    ...
                    <input type="button" value="保存标签" class="btn btn-info" onclick="$('#Save_Btn').click();;" />
                    <asp:LinkButton OnClick="UseLable_Click" class="btn btn-link" runat="server"><i class="fa fa-quote-left" aria-hidden="true"> </i> 引用标签</asp:LinkButton></div>
