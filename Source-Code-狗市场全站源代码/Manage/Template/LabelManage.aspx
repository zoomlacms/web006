...
<ol id="BreadNav" class="breadcrumb fixed-top w-100">
    ...
    <div class="float-left dropdown ml-3">
        <a href="javascript:;" class="btn btn-outline-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-plus-circle"></i> <%=Resources.L.添加标签 %></a>
...
<table class="table table-striped table-bordered table-hover">
   ...
   <%--                 <a  href="../APP/AddJsonP.aspx?LabelID=<%#Eval("LabelID") %>"  title="JsonP<%=Resources.L.跨域调用 %>"><i class="fa fa-list"></i><%=Resources.L.调用 %></a>--%>
                    <a  href="LabelCallTab.aspx?labelName=<%#Eval("LabelName") %>"><i class="fa fa-quote-left" aria-hidden="true"></i><%=Resources.L.引用 %></a>
                </td>
            </tr>
        </ItemTemplate>
