...
<div class="ml-auto"><a href="TemplateSetOfficial.aspx"> <i class="fa fa-cloud-download"></i> 云模板下载 </a></div>
</ol>
			...
			<ItemTemplate>
				<li class="Template_list_card">
					<div class="Template_box">
						...
						<ul>
						<li class="temp_title">
						<a href="javascript:;" title="作者:<%# GetTlpName("Author")%>" data-toggle="tooltip" data-placement="top"><i class="fa fa-copyright"></i></a>
						<a href="TemplateManage.aspx?setTemplate=<%#Eval("name") %>" title='<%# GetTlpName("Project")%>'><%# GetTlpName("Project")%></a>
							...
							<li class="temp_del">
							 <a href='/Template/<%#Eval("name") %>/view.jpg' class="lightbox"> <i class="fa fa-search-plus"></i> 预览</a>
