        ...
        <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="CommentID" PageSize="10"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="CommentShow.aspx?id=<%#Eval("CommentID") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                        <asp:LinkButton CommandName="Del2" CommandArgument='<%# Eval("CommentID") %>' runat="server" CssClass="option_style"><i class="fa fa-trash" title="删除"></i></asp:LinkButton>
                        <asp:LinkButton CommandName="Audit" CommandArgument='<%# Eval("CommentID") %>' runat="server" CssClass="option_style"><i class="fa fa-legal" title="审核"></i>审核</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
