...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" DataKeyNames="ModelID" PageSize="20" OnRowDataBound="Egv_RowDataBound" 
        ...
        AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover sysRow list_choice mb_8rem" 
                ...
                <ItemTemplate>
					<div class="btn-group">
					  ...
					  <div class="dropdown-menu">
						<a href="ModelField.aspx?ModelID=<%#Eval("ModelID") %>&ModelType=<%:ModelType %>" class="dropdown-item"><i class="fa fa-th"></i> 字段</a>
