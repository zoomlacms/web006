...
<div class="pull-right ml-auto"> <a href="/Shop/<%=proMod.ID %>.aspx" target="_blank" title="前台浏览"><span class="fa fa-eye"></span></a>
<span onclick="opentitle('/admin/Content/Node/EditNode.aspx?NodeID=<%=proMod.Nodeid %>','配置本节点');" class="fa fa-cog" title="配置本节点" style="cursor:pointer;margin-left:5px;"></span>
</div>
</ol></nav>
